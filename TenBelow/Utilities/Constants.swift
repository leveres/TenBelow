...
enum AppConstants {
    ...
    /// Use from nonisolated media URL helpers and background image loaders.
    nonisolated static func backendBaseURLForMedia() -> URL? {
        BackendURLConfiguration.baseURL()
    }
...
// MARK: - Backend URL (nonisolated; kept here so media loaders avoid cross-file visibility issues)

private enum BackendURLConfiguration {
